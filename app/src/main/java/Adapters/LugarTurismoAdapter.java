...
import com.example.turismoquevedo.R;

import java.util.List;

import Modelos.LugarTuristico;


public class LugarTurismoAdapter extends RecyclerView.Adapter<LugarTurismoAdapter.LugarTuristicoViewHolder> {

        private Context Ctx;
        private List<LugarTuristico> lstLugares;

        public LugarTurismoAdapter (Context mCtx, List<LugarTuristico> lstLugaresT) {
